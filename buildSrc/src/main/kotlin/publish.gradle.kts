        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/logingithubtest/test5/")
                    ...
                    developers {
                        developer {
                            id.set("logingithubtest")
                            name.set("logingithubtest")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/logingithubtest/test5.git")
                        developerConnection.set("scm:git:ssh://github.com/logingithubtest/test5.git")
                        url.set("https://github.com/logingithubtest/test5/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/logingithubtest/test5/issues")
                    }
                }
            }
        }
